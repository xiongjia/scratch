...
public class SqliteDialect extends Dialect {
   ...
   *   // temporary tables are only dropped when the connection is closed.
  ...
  public String getDropForeignKeyString() {
    final String err = "No drop foreign key syntax supported by SQLiteDialect";
  ...
  public String getAddForeignKeyConstraintString(String constraintName,
    ...
    final String err = "No add foreign key syntax supported by SQLiteDialect";
    throw new UnsupportedOperationException(err);
  }

  @Override
  public String getAddPrimaryKeyConstraintString(String constraintName) {
    final String err = "No add primary key syntax supported by SQLiteDialect";
    throw new UnsupportedOperationException(err);
  }
