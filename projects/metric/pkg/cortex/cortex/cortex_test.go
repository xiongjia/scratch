...
import (
	...
	"metric/pkg/cortex/chunk/aws"
	"metric/pkg/cortex/chunk/storage"
	"metric/pkg/cortex/frontend/v1/frontendv1pb"
	"metric/pkg/cortex/ingester"
	"metric/pkg/cortex/ring"
	"metric/pkg/cortex/ring/kv"
	"metric/pkg/cortex/ruler"
	"metric/pkg/cortex/scheduler/schedulerpb"
	"metric/pkg/cortex/storage/bucket"
	"metric/pkg/cortex/storage/bucket/s3"
