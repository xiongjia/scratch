...
import (
	...
	"metric/pkg/cortex/storage/bucket/azure"
	"metric/pkg/cortex/storage/bucket/filesystem"
	"metric/pkg/cortex/storage/bucket/gcs"
	"metric/pkg/cortex/storage/bucket/s3"
	"metric/pkg/cortex/storage/bucket/swift"
