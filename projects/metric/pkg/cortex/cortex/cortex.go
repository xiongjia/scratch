...
import (
	...
	"metric/pkg/cortex/alertmanager"
	"metric/pkg/cortex/alertmanager/alertstore"
	"metric/pkg/cortex/api"
	"metric/pkg/cortex/chunk"
	"metric/pkg/cortex/chunk/encoding"
	"metric/pkg/cortex/chunk/purger"
	"metric/pkg/cortex/chunk/storage"
	chunk_util "metric/pkg/cortex/chunk/util"
	"metric/pkg/cortex/compactor"
	"metric/pkg/cortex/configs"
	configAPI "metric/pkg/cortex/configs/api"
	"metric/pkg/cortex/configs/db"
	"metric/pkg/cortex/cortexpb"
	"metric/pkg/cortex/distributor"
	"metric/pkg/cortex/flusher"
	"metric/pkg/cortex/frontend"
	frontendv1 "metric/pkg/cortex/frontend/v1"
	"metric/pkg/cortex/ingester"
	"metric/pkg/cortex/ingester/client"
	"metric/pkg/cortex/querier"
	"metric/pkg/cortex/querier/queryrange"
	"metric/pkg/cortex/querier/tenantfederation"
	querier_worker "metric/pkg/cortex/querier/worker"
	"metric/pkg/cortex/ring"
	"metric/pkg/cortex/ring/kv/memberlist"
	"metric/pkg/cortex/ruler"
	"metric/pkg/cortex/ruler/rulestore"
	"metric/pkg/cortex/scheduler"
	"metric/pkg/cortex/storage/tsdb"
	"metric/pkg/cortex/storegateway"
	"metric/pkg/cortex/tenant"
	"metric/pkg/cortex/util"
	"metric/pkg/cortex/util/fakeauth"
	"metric/pkg/cortex/util/flagext"
	"metric/pkg/cortex/util/grpcutil"
	util_log "metric/pkg/cortex/util/log"
	"metric/pkg/cortex/util/modules"
	"metric/pkg/cortex/util/process"
	"metric/pkg/cortex/util/runtimeconfig"
