...
public class Problem0001TwoSumTest {
  ...
  public void twoSumTest1() {
    ...
    final int[] result = problem.solution001(testSrc, 9);
  ...
  public void twoSumTest2() {
    final int[] testSrc = {};
    final int[] result = problem.solution001(testSrc, 0);
  ...
  public void twoSumTest3() {
    ...
    final int[] result = problem.solution001(testSrc, 10);
  ...
  public void twoSumTest4() {
    ...
    final int[] result = problem.solution001(testSrc, 11);
    Assert.assertNull(result);
  }
  ...
  public void twoSumTest5() {
    final int[] testSrc = {2, 7, 11, 15};
    final int[] result = problem.solution002(testSrc, 9);
    Assert.assertEquals(testSrc[result[0]] + testSrc[result[1]], 9);
  }
}
