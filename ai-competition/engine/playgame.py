...
cwd_playgame = os.path.split(os.path.realpath(__file__))[0]
sys.path.append(cwd_playgame)
sys.path.append(os.path.join(cwd_playgame, "../sdk"))
sys.path.append(os.path.join(cwd_playgame, "../sdk/python"))
sys.path.append(os.path.join(cwd_playgame, "../sdk/sample_bots"))
try:
